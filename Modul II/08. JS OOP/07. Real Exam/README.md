...
*   properties
    ...
    *   `name`
        *   A string with length **between 2 and 40** characters
        *   Passed as parameter to a constructor or init function
...
*   properties
    ...
    *   genre
        *   A string with length **between 2 and 20** characters
        *   Passed as parameter to a constructor or init function
...
*   methods:
    ...
    *   find(options)
        ...
        *   The requirements are provided as an `options` object
            ...
            *   Each item that all the properties in the `options` object must be returned
            *   __Example:__
                    ...
                    //find({id: 3, name: 'Samsung Galaxy S2'})
