...
using TDD.PokerHandsChecker.IsFourOfAKind.PokerDemo;

namespace TDD.PokerHandsChecker.IsFourOfAKind
{
    [TestClass]
    public class PokerHandsCheckerIsFourOfAKindTests
    {
        ...
        public void TestOnHandWithNoCards()
        {
            ...
            var expected = false;
            var actual = _pokerHandsChecker.IsFourOfAKind(handWithNoCards);
        ...
        public void TestOnHandWithFourDifferentCardsOnEqualSuit()
        {
            ...
            var expected = false;
            var actual = _pokerHandsChecker.IsFourOfAKind(handWithFiveDifferentCardsOnEqualSuit);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
        {
            ...
            var expected = false;
            var actual = _pokerHandsChecker.IsFourOfAKind(handWithTwoEqualOfFiveCardsOnEqualSuit);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithSixDifferentCards()
        {
            ...
            var expected = false;
            var actual = _pokerHandsChecker.IsFourOfAKind(handWithSixDifferentCards);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualCards()
        {
            ...
            var expected = false;
            var actual = _pokerHandsChecker.IsFourOfAKind(handWithTwoEqualCard);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithFiveEqualCards()
        {
            ...
            var expected = false;
            var actual = _pokerHandsChecker.IsFourOfAKind(handWithFiveEqualCards);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualPairOfCards()
        {
            ...
            var expected = false;
            var actual = _pokerHandsChecker.IsFourOfAKind(handWithTwoEqualPairOfCards);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualOfFourCards()
        {
            ...
            var expected = false;
            var actual = _pokerHandsChecker.IsFourOfAKind(handWithTwoEqualOfFourCards);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
        {
            ...
            var expected = false;
            var actual = _pokerHandsChecker.IsFourOfAKind(handWithTwoEqualOfSixCards);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsOnEqualSuit()
        {
            ...
            var expected = false;
            var actual = _pokerHandsChecker.IsFourOfAKind(handWithTwoEqualOfSixCardsOnEqualSuit);
            Assert.AreEqual(expected, actual);
        }
