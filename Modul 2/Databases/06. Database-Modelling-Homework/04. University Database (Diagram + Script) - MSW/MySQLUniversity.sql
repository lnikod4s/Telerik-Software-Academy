...
CREATE TABLE `courses` (
  ...
  CONSTRAINT `fk_Courses_Departaments1` FOREIGN KEY (`Departaments_DepartamentId`) REFERENCES `departments` (`DepartamentId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `professors` (
  ...
  CONSTRAINT `fk_Professors_Departaments1` FOREIGN KEY (`Departaments_DepartamentId`) REFERENCES `departments` (`DepartamentId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2015-10-02 12:21:50
