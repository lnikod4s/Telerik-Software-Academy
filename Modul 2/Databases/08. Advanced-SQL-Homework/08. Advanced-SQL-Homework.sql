...
-- Don't forget to define identity, primary key and appropriate foreign
-- key.
-- Issue few SQL statements to insert, update and delete of some data in
-- the table.
-- Define a table WorkHoursLogs to track all changes in the WorkHours 
-- table with triggers.
...
------------------------------------------------------------------------
-- TASK 30: Start a database transaction, delete all employees from the 
-- 'Sales' department along with all dependent records from the pother 
-- tables.
...
------------------------------------------------------------------------
-- TASK 31: Start a database transaction and drop the table Employees-
-- Projects.
